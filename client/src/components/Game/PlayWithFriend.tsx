...
function PlayWithFriend({ socket, funTosetResultShow }: { socket: any, funTosetResultShow: any }) {
	...
	return (
		<div
			className="flex flex-col items-center justify-center gamecontainer"
			style={{ width: "100%", height: "100%", overflow: "hidden", gap: "12px" }}
		>
			<canvas
				ref={canvasRef}
				width={800}
			...
			<Button
				variant="primary"
				style={{ width: "200px", height: "42px", backgroundColor: "#24A8AF", borderRadius: "10px", flexShrink: 0 }}
				onClick={chnageColor}
			>
				Change Table Colour
			</Button>
